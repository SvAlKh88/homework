...
def transaction_amount(
        transaction_list) -> float:  # принимаем возвращенный список словарей с данными о финансовых транзакциях из функции  src.utils import returns_list_of_dictionaries
...
if __name__ == "__main__":  # pragma:no cover
    list_of_operations = returns_list_of_dictionaries(
        "../data/operations.json")  # список транзакций в формате Python-объекта
